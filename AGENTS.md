...
- `.github/workflows/` - nao existe ainda
- `.env.example` - nao existe ainda
...
Comandos de backend, teste integrado e smoke publico devem ser adicionados apos criacao do backend, Dockerfiles, EasyPanel e dominio.
...
- Estrutura tecnica real: frontend existe em `frontend/`; ainda sem backend, banco, scripts, testes integrados, `.env.example`, Dockerfiles, CI/CD ou remoto Git configurado
